 ...
 */
public class ExpresionSuma extends Nodo implements Constantes {

    private int id = R47;
    private Nodo exp1, exp2;
    private String suma;

    public ExpresionSuma(Pila<ElementoPila> p) {
        p.desapila();
        exp2 = ((NoTerminal) p.desapila()).getNodo();
        p.desapila();
        suma = ((Terminal) p.desapila()).getLexema();
        p.desapila();
